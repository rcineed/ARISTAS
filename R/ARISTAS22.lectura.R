...
#' En esta base 'ARISTAS22.lectura' se incluye la información de desempeño en lectura.
#'
#'
#' @format ## `ARISTAS22.lectura`
#' Una base de datos con 11546 filas (estudiantes) y 470 columnas (variables)
#' \describe{
...
#'   \item{LEC1009, ..., LEC938}{Resultados a ítems de la prueba.}

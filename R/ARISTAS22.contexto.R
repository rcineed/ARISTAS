#' Datos ARISTAS contexto edición 2022
#'
...
#' En esta base 'ARISTAS22.contexto' se incluye la información de contexto familiar y entorno.
#'
#'
#' @format ## `ARISTAS22.contexto`
#' Una base de datos con 11546 filas (estudiantes) y 484 columnas (variables)
#' \describe{
...
#'   \item{EF1m, ..., EF70}{Resultados a ítems de la prueba.}
#'   \item{IND_CXTO}{Respuesta al cuestionario (1: "El alumno respondió el cuestionario de contexto", vacía: "El alumno no respondió el cuestionario de contexto")}
#'   \item{ESTSENTPER_E_ESC50}{Índice de sentido de pertenencia}
#'   \item{VINCENTREEST_E_ESC50}{Índice de vínculo entre estudiantes}
#'   \item{VINESTADS_E_ESC50}{Índice de vínculo entre estudiantes y adscriptos}
#'   \item{VINESTPROF_E_ESC50}{Índice de vínculo entre estudiantes y docentes}
#'   \item{VOZESTU_E_ESC50}{Índice de voz del estudiante}
#'   \item{ACTITUDLEC_E_ESC50}{Índice de actitud hacia la lectura}
#'   \item{ACTITUDMAT_E_ESC50}{Índice de actitud hacia la matemática}
#' }

#' Datos ARISTAS lectura edición 2022
#'
...
#' En esta base 'ARISTAS22.matematicas' se incluye la información de desempeño en matemáticas
#'
#'
#' @format ## `ARISTAS22.matematicas`
#' Una base de datos con 11546 filas (estudiantes) y 415 columnas (variables)
#' \describe{
...
#'   \item{EDAD}{Edad}
#'   \item{AlumnoGenero}{Sexo (F: "Femenino", M: "Masculino")}
...
#'   \item{ESCS_Alumno_cat}{Estatus socioeconómico y cultural del estudiante en quintiles (Q1: "Muy desfavorable", Q2: "Desfavorable", Q3: "Medio", Q4: "Favorable", Q5: "Muy favorable")}
...
#'   \item{MAT1010, ..., MAT860}{Resultados a ítems de la prueba.}
#'   \item{TotResp}{"Cantidad de ítems visualizados (sin contar los ítems eliminados en el proceso de calibración)}
#'   \item{IND_Estudiante_ITEMS}{Respuesta al cuestionario (1: "El alumno hizo la prueba", vacía: "El alumno no hizo la prueba")}
#' }
#' @source <https://www.ineed.edu.uy/base-de-datos-aristas-media-2022/>
"ARISTAS22.matematicas"
